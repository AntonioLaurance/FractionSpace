...
class Usuario(models.Model):
    ...
    contraseña = models.CharField(null = True)
    grado = models.IntegerField(null = True)                       # All 6 for now
    grupo = models.CharField(max_length = 1, null = True)            # Can be 'A' or 'B'
    num_lista = models.IntegerField(null = True)                   # Define a range
